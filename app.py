...
st.title("Screener avanzado USA – Optimizado para Streamlit Cloud")
...
# ============================================================
# TICKERS (reducido para evitar bloqueo)
# ============================================================
TICKERS = [
    "AAPL","MSFT","AMZN","GOOGL","META",
    "NVDA","TSLA","UNH","XOM","JPM"
]
...
def get_price_data(ticker):
    try:
        return yf.download(ticker, period="6mo", auto_adjust=True)
    except:
        return None
...
def volume_pattern(data):
    ...
    return high_vol_up.sum() > 2, low_vol_down.sum() > 2
...
for i, ticker in enumerate(TICKERS):
    ...
    # Distancia a máximos
    max_6m = close.max()
    dist_high = (max_6m - last_price) / max_6m
